...
このソフトウェアはオープンソースとして無料で提供していますが、導入サポートが必要な個人・法人様には**有料サポートサービス**を提供しています。

### 24時間365日稼働について

**安価な専用サーバ（Raspberry Pi等）を活用することで、省電力で24時間365日の自動転送が可能です。**

- 💡 消費電力: 約3-5W（月額電気代 約50-100円）
- 🏠 自宅・オフィスに設置可能
- 🔌 常時稼働でリアルタイム転送
- 💰 VPS不要でランニングコスト削減
...
- 🔧 **初期セットアップ代行** - 設定ファイル作成、接続テスト、動作確認
- 🖥️ **サーバー構築代行** - VPS/クラウド環境での24時間稼働設定
- 🍓 **Raspberry Pi専用機セットアップ** - 省電力24時間稼働専用機の構築・設置（おすすめ）
- 📞 **技術サポート** - トラブルシューティング、運用相談
- 🏢 **企業向けカスタマイズ** - 複数アカウント対応、特殊要件対応
- 📚 **導入トレーニング** - 操作方法の講習、運用マニュアル作成

### お問い合わせ

サポートをご希望の方は、以下のメールアドレスまでお問い合わせください：

**📧 info+mailforwarder@nongsoft.com**

お問い合わせの際は、以下の情報をご記載いただけるとスムーズです：
- お名前・会社名
- 利用されているプロバイダ名
- サポート内容（初期セットアップ、サーバー構築、トラブル対応など）
- ご連絡先（メールアドレス・電話番号）
...
サポートをご希望の方は、以下よりお問い合わせください：

- GitHub Issues: [https://github.com/ShigetoshiMizuno/pop-forwarder/issues](https://github.com/ShigetoshiMizuno/pop-forwarder/issues)
- 企業・法人の方: Issue内でお問い合わせいただければ、個別にご連絡いたします
